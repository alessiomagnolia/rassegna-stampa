            ...
            <div class="article-content">
                ...
                <div style="margin-top:10px; display:flex; flex-direction:column; gap:6px;">
                    <div style="display:flex; align-items:center; gap:6px; flex-wrap:nowrap;">
                        <label for="uploadLogo_${idx}" style="cursor:pointer;display:inline-flex;align-items:center;gap:4px;height:28px;padding:0 9px;font-size:0.75rem;font-weight:500;font-family:inherit;text-transform:none;letter-spacing:normal;border-radius:6px;border:1px solid rgba(255,255,255,0.28);color:rgba(255,255,255,0.85);background:transparent;white-space:nowrap;box-sizing:border-box;flex-shrink:0;">
                        ...
                        <button type="button" onclick="copyArticleLink(${idx})" title="Copia link originale" style="cursor:pointer;display:inline-flex;align-items:center;gap:4px;height:28px;padding:0 9px;font-size:0.75rem;font-weight:500;font-family:inherit;text-transform:none;letter-spacing:normal;border-radius:6px;border:1px solid rgba(255,255,255,0.28);color:rgba(255,255,255,0.85);background:transparent;white-space:nowrap;box-sizing:border-box;flex-shrink:0;">
                            <i data-feather="copy" style="width:12px;height:12px;flex-shrink:0;"></i> Copia link
                        </button>
                    </div>
                    ${article.logoBase64 ? `<div style="display:inline-flex;align-items:center;background:white;padding:2px 8px;border-radius:4px;max-width:140px;"><img src="${article.logoBase64}" style="max-height:18px;max-width:120px;object-fit:contain;display:block;"></div>` : ''}
                </div>
            </div>
